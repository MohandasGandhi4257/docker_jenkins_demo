pipeline {
    ...
    environment {
        GIT_REPOSITORY_URL = 'https://github.com/MohandasGandhi4257/docker_jenkins_demo.git'
        DOCKER_IMAGE_NAME = 'kratos4257/docker_jenkins_demo'
        IMAGE_TAG = '1.0'
    }
